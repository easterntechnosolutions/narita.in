...
class ModelSettingModule extends Model {
	...
	public function editModule($module_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "ishi_sliderimage WHERE module_id = '" . (int)$module_id . "'");
	...
	public function deleteModule($module_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "ishi_sliderimage WHERE module_id = '" . (int)$module_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "ishi_bannerblock WHERE module_id = '" . (int)$module_id . "'");
	}
