	...
	public function add() {
		...
		if ($product_info) {
			if ($this->customer->isLogged()) {
				...
				$json['total_items'] = sprintf($this->language->get('text_wishlist_items'), $this->model_account_wishlist->getTotalWishlist());
				...
				$json['total_items'] = sprintf($this->language->get('text_wishlist_items'), (isset($this->session->data['wishlist']) ? count($this->session->data['wishlist']) : 0));
