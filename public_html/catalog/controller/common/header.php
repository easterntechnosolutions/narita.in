...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if ($this->customer->isLogged()) {
			...
			$data['item_wishlist'] = sprintf($this->language->get('item_wishlist'), $this->model_account_wishlist->getTotalWishlist());
			
		} else {
			$data['text_wishlist'] = sprintf($this->language->get('text_wishlist'), (isset($this->session->data['wishlist']) ? count($this->session->data['wishlist']) : 0));
			$data['item_wishlist'] = sprintf($this->language->get('item_wishlist'), (isset($this->session->data['wishlist']) ? count($this->session->data['wishlist']) : 0));
		}
