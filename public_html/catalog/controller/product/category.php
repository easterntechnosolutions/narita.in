	...
	public function index() {
		...
		if ($category_info) {
			...
			if ($this->request->server['HTTPS']) {
				$data['category_image'] = $this->config->get('config_ssl') . 'image/' . $category_info['image'];
			} else {
				$data['category_image'] = $this->config->get('config_url') . 'image/' . $category_info['image'];
			}
			}else{
				$data['category_image'] = $this->config->get('config_url') . 'image/no_image.png';
			}
			...
			$data['url_category'] = $this->url->link('product/category_view_more');
			$data['page'] = $page;
			$data['filter'] = $filter;
