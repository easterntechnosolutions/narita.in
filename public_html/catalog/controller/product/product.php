...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$specialDates = $this->model_catalog_product->getProductSpecialsDate($data['product_id']);	
			...
			if(isset($product_info['discount_percentage']) && !empty($product_info['discount_percentage'])){
				$data['discount_percentage'] = $product_info['discount_percentage'];
			...
			$themeinfo = $this->model_catalog_product->getThemeOption();
