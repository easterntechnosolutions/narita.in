...
jQuery(function ($) {
    $("#_desktop_top_menu .top-menu")
        .click(function(e) {
            var link = $(this);            
            var item = link.parent("#_desktop_top_menu li");            
            if (item.hasClass("active")) {
                item.removeClass("active").children("#_desktop_top_menu li a").removeClass("active");
            } else {
                item.addClass("active").children("#_desktop_top_menu li a").addClass("active");
            }            
            if (item.children("#_desktop_top_menu").length > 0) {
        ...
        .each(function() {
            ...
            if (link.get(0).href === location.href) {
                link.addClass("active").parents("#_desktop_top_menu li").addClass("active");
                return false;
            }
        });
});
