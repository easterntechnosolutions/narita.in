...
class __TwigTemplate_db2b88d801ba5281216f0bd0c631c201c434b8d380da6c1ea67f0b97a3e0a05c extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            ...
            echo "').on(\"change keyup paste\", function () {
                                      if(\$(this).val() != '') {
                                        \$('.update";
            // line 87
            echo twig_get_attribute($this->env, $this->source, $context["product"], "cart_id", [], "any", false, false, false, 87);
            echo "').trigger('click');
                                      }
                                      });
                                  },1000);
